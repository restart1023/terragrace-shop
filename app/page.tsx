              ...
              >
                ...
                <div className="p-6 text-center sm:p-8 md:p-10">
                  ...
                  <div className="mt-6 flex justify-center">
                    <div className="inline-flex min-h-[50px] items-center justify-center bg-black px-7 text-[12px] font-semibold tracking-[0.08em] text-white transition hover:opacity-85">
                      商品詳細
                    </div>
                  </div>
                </div>
